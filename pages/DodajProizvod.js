...
import { postProizvodi } from "../services/ProizvodiServis";


const PostProizvodi = () => {
    const [ID, setID] = useState()
    const [nazivProizvoda, setNaziv] = useState()
    const [opis, setOpis]=useState()
    const [cena, setCena]=useState()
    const [idkp, setIDKP]=useState()
    
    const postClick = () => {
      console.log(ID, nazivProizvoda, opis, cena, idkp)
      postProizvodi(ID, nazivProizvoda, opis, cena, idkp).then(response => 
                  ...
                  <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    ...
                    <form class="mx-1 mx-md-4">
                      ...
                      <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                          <button type="button" onClick={() => postClick()}class="btn btn-primary btn-lg">Dodajte novi proizvod</button>
                        </div>
